...
import com.sleepingcat.hencodercompose.model.TYPE_IMAGE_TEXT
import com.sleepingcat.hencodercompose.model.TYPE_VIDEO
...
class FeedAdapter : PagingDataAdapter<Feed, FeedAdapter.FeedViewHolder>(object : DiffUtil.ItemCallback<Feed>() {
    ...
    override fun onBindViewHolder(holder: FeedViewHolder, position: Int) {
        ...
        holder.itemView.findViewById<TextView>(R.id.feed_text).text = item!!.feedsText
    }
